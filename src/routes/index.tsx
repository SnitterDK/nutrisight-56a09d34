...
function Home() {
  ...
  return (
    <>
      ...
      {/* MTP — Massive Transformative Purpose (ExO playbook) */}
      <section className="container-page py-10">
        <div className="rounded-3xl border-2 border-primary/40 bg-gradient-to-br from-primary/10 via-card to-brand-blue/10 p-8 md:p-12">
          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-primary">
            <Target className="h-4 w-4" /> Our Massive Transformative Purpose
          </div>
          <p className="mt-4 text-2xl font-extrabold leading-tight md:text-4xl">
          ...
          <div className="mt-5 flex flex-wrap gap-3 text-sm">
            <Link to="/manifesto" className="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2 font-semibold text-primary-foreground">
              Read the ExO manifesto <ArrowRight className="h-4 w-4" />
            </Link>
            <Link to="/ai-operations" className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-5 py-2 font-semibold">
              Live metrics
            </Link>
          </div>
        </div>
